package com.biz.iolist.service.product;

import com.biz.iolist.persistence.ProductDTO;

public class ProductServiceExt2 extends ProductServiceExt1 {
	
	protected boolean checkStrInt(String str) {
		int check = 0;
		try {
			check = Integer.valueOf(str);
		} catch (Exception e) {
