...
public class DBContract {
	...
	public static class SQL {
		...
		public static final String SELECT_STUDENT = " select "
				+ " ST_NUM,"
				+ " ST_NAME,"
				+ " ST_TEL,"
				+ " ST_ADDR,"
		...
		public static final String SELECT_SUB = " select "
				+ " SB_CODE, SB_NAME, SB_PRO from tbl_sub ";
		
		public static final String SELECT_DEPT = " select "
				+ "D_CODE, D_NAME, D_PRO, D_TEL from tbl_dept ";
